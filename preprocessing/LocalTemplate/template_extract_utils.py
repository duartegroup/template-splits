...
# 
# This version has been archived from February 2024 and redistributed by 
# Sara Tanovic on 10/11/2025, to preserve reproducibility for academic research.
# 
...
bond_type_map = {'SINGLE': '-', 'DOUBLE': '=', 'TRIPLE': '#', 'AROMATIC': '@', 'DATIVE': '-'}
